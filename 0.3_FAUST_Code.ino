...
#include "0.3_FAUST_Code"


// create an object from the files --> name the object
0.3_FAUST_Code 0.3_FAUST_Code;
...
//
// from 0.3_FAUST_Code,0 (out 1) to out,0 (out 1 - DAC of the shield)
AudioConnection patchCord0(0.3_FAUST_Code,0,out,0);
// from 0.3_FAUST_Code,0 (out 1) to out,1 (out 2 - DAC of the shield)
AudioConnection patchCord1(0.3_FAUST_Code,0,out,1);
...
void loop() 
{
  ...
  0.3_FAUST_Code.setParamValue("freq",random(50,1000));
