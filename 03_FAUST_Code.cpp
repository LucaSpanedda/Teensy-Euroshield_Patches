...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "03_FAUST_Code.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.3");
		m->declare("name", "03_FAUST_Code");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("03_FAUST_Code");
	...
	#define FAUST_FILE_NAME "03_FAUST_Code.dsp"
...
03_FAUST_Code::03_FAUST_Code() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
void 03_FAUST_Code::updateImp(void)
{
#if MIDICTRL
...
void 03_FAUST_Code::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void 03_FAUST_Code::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float 03_FAUST_Code::getParamValue(const std::string& path)
{
