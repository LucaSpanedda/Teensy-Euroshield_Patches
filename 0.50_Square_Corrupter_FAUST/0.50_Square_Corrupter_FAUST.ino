...
// from FAUST_Code,1 (out 2) to out,1 (out 2 - DAC of the shield)
AudioConnection patchCord1(FAUST_Code,1,out,1);
...
int lowerPotValue = analogRead(lowerPotInput);
  ...
  FAUST_Code.setParamValue("gain",float(lowerPotValue)/1);
