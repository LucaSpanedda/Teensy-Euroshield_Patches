...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		fSampleRate = sample_rate;
		fConst0 = (8.0f / std::min<float>(192000.0f, std::max<float>(1.0f, float(fSampleRate))));
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (638.219482f * fSlow1);
		float fSlow3 = (fConst0 * (fSlow2 - float(int(fSlow2))));
		float fSlow4 = (1137.69568f * fSlow1);
		float fSlow5 = (fConst0 * (fSlow4 - float(int(fSlow4))));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			fRec0[0] = (fSlow3 + (fRec0[1] - float(int((fSlow3 + fRec0[1])))));
			float fTemp0 = (fRec0[0] + -0.5f);
			int iTemp1 = (fTemp0 < 0.0f);
			iVec0[0] = (0 - iTemp1);
			int iTemp2 = (fTemp0 > 0.0f);
			iVec1[0] = iTemp2;
			output0[i0] = FAUSTFLOAT((fSlow0 * float(((iVec0[1] + (iVec1[1] + iTemp1)) - iTemp2))));
			...
			iVec3[0] = iTemp5;
			output1[i0] = FAUSTFLOAT((fSlow0 * float(((iVec2[1] + (iVec3[1] + iTemp4)) - iTemp5))));
			fRec0[1] = fRec0[0];
			iVec0[1] = iVec0[0];
			iVec1[1] = iVec1[0];
			fRec1[1] = fRec1[0];
